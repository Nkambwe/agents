...
public class SamConstant {
    public final static String SAM_BASEURL = "http://localhost:5280";
    public final static String SORT_CODE = "LASTSORTCODE";
    public final static String TIMEOUT = "SESSIONTIMEOUT";
    public final static String IND_URL = "INDIVIDUALATTACHMENTURL";
